...
import { useGetListsOnBoardTrelloIntegrationOptions } from "../hooks/trelloIntegration";

interface ISelectListsOnBoardTrelloIntegrationProps extends SelectProps {
  onCreate?: (list: { id: string; name: string }) => void;
...
const SelectListsOnBoardTrelloIntegration = forwardRef<
  any,
  ISelectListsOnBoardTrelloIntegrationProps
>(
  (
    ...
    return (
      <SelectComponent
        ...
        placeholder={`Selecione ${isMulti ? "as listas" : "a lista"}`}
